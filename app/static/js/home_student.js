      ...
      if (data.success) {
        ...
        data.classs.forEach((classInfo) => {
          ...
          row.innerHTML = `
                    ...
                    <td>
                        <ul class="list-inline mb-0" style="margin-left: 29px;">
...
document
  ...
  .addEventListener("click", function (event) {
    ...
    if (!classId.value) {
      ...
      messageDiv.style.color = "red"; // Đặt màu đỏ cho thông báo
      allFilled = false;
    }
    if (!enrollmentKey.value) {
      messageDiv.textContent += "Please give enrollment key! ";
      messageDiv.style.color = "red"; // Đặt màu đỏ cho thông báo
      allFilled = false;
    }
